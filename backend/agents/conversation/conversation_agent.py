...
class ConversationAgent:
    ...
    def _system_prompt(self, context: dict, intent: str) -> str:
        ...
        base = (
            ...
            f"CRITICAL RULES:\n"
            f"  1. Keep these two fact sources completely separate:\n"
            ...
            f"  2. Do NOT open your reply with 'I'm Prashant Biswas from Ganit' or any "
            f"re-introduction of yourself. That line is used only in the initial cold email. "
            f"This is a follow-up conversation — jump straight into the reply.\n\n"
            f"{prospect_block}\n"
            f"{sender_block}"
        )
